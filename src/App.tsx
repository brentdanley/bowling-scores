...
const App = () => {
  ...
  return (
    <div className={styles.app}>
      ...
      <Rolls
        rolls={rolls}
        updateRolls={setRolls}
        score={totalScore}
        updateScore={setTotalScore}
      />
